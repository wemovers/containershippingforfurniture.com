...
// Import all images
const img = import.meta.glob('../assets/img/*', { eager: true });

const getImagePath = (filename) => {
  const matchedPath = Object.keys(img).find((path) => path.includes(filename));
  return matchedPath ? img[matchedPath].default : '';
};
