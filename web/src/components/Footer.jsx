...
const Footer = () => {
  // 🎨 Updated Theme
  const bgColor = '#FCB53B';       // 🌞 Warm Golden Background
  const accentColor = '#FFE797';   // 🌻 Soft Yellow Accent
  const secondaryColor = '#84994F';// 🌿 Olive Green Hover/Highlight
  ...
  return (
    ...
    >
      ...
      {/* ✅ Search By Location (Horizontal Grid) */}
      <div>
